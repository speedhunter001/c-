...
class Shapes {
	...
	virtual void set_pen_brush(wxColour input_pen, wxColour input_brush);
	virtual void set_pen_width(long input_pen_width);
    virtual int get_num_points();
	virtual vector<Point> get_points();
	virtual wxColour get_pen();
	virtual wxColour get_brush();
	virtual long get_pen_width();
