...
/// Created:   10/04/2019 8:29:14 AM
/// @section   DESCRIPTION
///            paint1Frm class implementation
///
///------------------------------------------------------------------
...
////Event Table Start
BEGIN_EVENT_TABLE(paint1Frm,wxFrame)
	////Manual Code Start
	////Manual Code End
	
	EVT_CLOSE(paint1Frm::OnClose)
	
	EVT_UPDATE_UI(ID_WXPANEL1,paint1Frm::WxPanel1UpdateUI)
END_EVENT_TABLE()
////Event Table End

paint1Frm::paint1Frm(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &position, const wxSize& size, long style)
...
void paint1Frm::CreateGUIControls()
{
	...
	WxPanel1 = new BasicDrawPane(this);// ,ID_WXPANEL1, wxPoint(50, 47), wxSize(185, 160));

	SetTitle(_("paint1"));
	SetIcon(wxNullIcon);
	SetSize(1500,1000); //3-width 4-length
	Center();
	
	////GUI Items Creation End
}

void paint1Frm::OnClose(wxCloseEvent& event)
{
	Destroy();
}
 ...
 */
void paint1Frm::WxToggleButton1Click(wxCommandEvent& event)
{
 ...
 * WxPanel1UpdateUI
 */
void paint1Frm::WxPanel1UpdateUI(wxUpdateUIEvent& event)
{
	// insert your code here
}
